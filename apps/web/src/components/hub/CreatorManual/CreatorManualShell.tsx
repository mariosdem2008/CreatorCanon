...
export function CreatorManualShell({ manifest, activeRouteKey, children }: CreatorManualShellProps) {
          ...
          <div className={styles.topbarInner}>
            <Link href={getCreatorManualHomeRoute(manifest.hubSlug)} className={styles.brandLockup}>
              {avatarUrl ? (
                ...
                <span className={styles.logoMark} aria-hidden="true">{mark}</span>
              )}
            ...
            <details className={styles.mobileMenu}>
              ...
              <nav className={styles.mobilePanel} aria-label="Creator manual mobile navigation">
                <NavLinks items={navItems} manifest={manifest} activeRouteKey={activeRouteKey} mobile />
              </nav>
            </details>
          </div>
        </header>
