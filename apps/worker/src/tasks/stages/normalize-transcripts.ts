...
/** Parse a VTT file into plain timestamped text chunks. */
...
/**
 * Merge adjacent VTT chunks into sentence-like units.
 * Runs of 3–6 chunks are merged unless a chunk ends in sentence-final punctuation.
 */
...
/** Remove filler words and clean up common transcript noise. */
...
export async function normalizeTranscripts(
  ...
  for (const transcript of input.transcripts) {
    ...
    // Check if a normalized version already exists for this transcript asset
