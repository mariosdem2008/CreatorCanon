ALTER TYPE "inbox_item_kind" ADD VALUE 'run_audit_ready';--> statement-breakpoint
ALTER TYPE "media_asset_type" ADD VALUE 'video_mp4';--> statement-breakpoint
ALTER TYPE "run_status" ADD VALUE 'audit_ready';--> statement-breakpoint
ALTER TYPE "transcript_provider" ADD VALUE 'whisper-1';--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "workshop_stage" (
	"id" text PRIMARY KEY NOT NULL,
	"workspace_id" text NOT NULL,
	"run_id" text NOT NULL,
	"payload" jsonb NOT NULL,
...
--> statement-breakpoint
DROP INDEX IF EXISTS "channel_youtube_channel_id_unique";--> statement-breakpoint
DROP INDEX IF EXISTS "video_workspace_youtube_id_unique";--> statement-breakpoint
ALTER TABLE "hub" ALTER COLUMN "template_key" SET DEFAULT 'editorial_atlas';--> statement-breakpoint
DO $$ BEGIN
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "workshop_stage" ADD CONSTRAINT "workshop_stage_workspace_id_workspace_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspace"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "workshop_stage" ADD CONSTRAINT "workshop_stage_run_id_generation_run_id_fk" FOREIGN KEY ("run_id") REFERENCES "public"."generation_run"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "visual_moment_run_score_idx" ON "visual_moment" USING btree ("run_id","usefulness_score");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "workshop_stage_run_position_idx" ON "workshop_stage" USING btree ("run_id","position");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "video_uploading_created_at_idx" ON "video" USING btree ("upload_status","created_at") WHERE "video"."upload_status" = 'uploading';--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "channel_youtube_channel_id_unique" ON "channel" USING btree ("youtube_channel_id") WHERE "channel"."youtube_channel_id" IS NOT NULL;--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "video_workspace_youtube_id_unique" ON "video" USING btree ("workspace_id","youtube_video_id") WHERE "video"."youtube_video_id" IS NOT NULL;